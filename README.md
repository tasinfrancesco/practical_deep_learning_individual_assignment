# practical_deep_learning_individual_assignment
Assignment for PSL practical deep learning course


Includes code for:
1) EDA (EDA_and_code_for_figures.ipynb)
2) baseline CNN training (baseline_training.ipynb)
3) hyperparameter search (hyperparam_search.ipynb)
4) 50 epoch run with 4 layered CNN (50_epoch_run.ipynb)
5) transfer learning with resnet18 (resnet18_transfer_learning)
6) making of figures (EDA_and_code_for_figures.ipynb)
